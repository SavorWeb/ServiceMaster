...
<div class="wrapper">
	...
	<div class="pageimg">
		<img id="header-img" class="editable" src="assets/photos/serviceboxes.jpg" alt="...">
	</div>
	...
	<div class="padded"> <!-- START CONTENT -->
		...
		<section>
			<article>
				<div class="c6">
					<h1 class="editable" id="header-1">General FAQ</h1>
					<div class="panel-group editable" id="accordion">
						<div class="panel panel-default repeatable">
							...
							<div id="collapseOne" class="panel-collapse collapse">
								<div class="panel-body">
									<p>A technician will typically be on site within 2-4 hours.</p>
								</div>
							</div>
						</div>
						<div class="panel panel-default repeatable">
						...
						<div class="panel panel-default repeatable">
							...
							<div id="collapseThree" class="panel-collapse collapse">
								<div class="panel-body">
									<p>We do not have to have the claim number to begin restoration. However, we will need the claim number before the conclusion of the job in order to bill your insurance company, so once you receive it pleases contact our office.</p>
								</div>
							</div>
						</div>
						<div class="panel panel-default repeatable">
							...
							<div id="collapsefour" class="panel-collapse collapse">
								<div class="panel-body">
									<h3>Water</h3>
									<p>Drying time on water losses is determined by a combination of factors, including the location, the duration and source of water, the types of building materials, the weather conditions, and how quickly emergency services begin. Through consistent monitoring and evaluation of the drying process, we can determine when the drying is complete. Your carpet may feel dry to the touch, but padding and sub-floors may still be wet underneath. While there are no rules to determine how long your property will take to dry, we can tell you, on average, it may take between three to five days or more, depending on the conditions.</p>

									<h3>Fire & Smoke</h3>
									<p>There are many variables and many services involved in fire and smoke restoration, it is difficult to predict exactly how long the complete restoration of your home or business will take. Your Project Manager should go over the scope and expected schedule of events for your project with you once they have completed the initial inspection. </p>
								</div>
							</div>
						</div>
						<div class="panel panel-default repeatable">
							...
							<div id="collapsefive" class="panel-collapse collapse">
								<div class="panel-body">
									<p>Our technicians will place and monitor equipment to achieve optimal results in the shortest amount of time. It is important to the drying process that the equipment remain on at all time in the location placed by the SMNI technicians. Please notify our office immediately if there is an interruption in power or if the equipment turns off.</p>
								</div>
							</div>
						</div>
						<div class="panel panel-default repeatable">
							...
							<div id="collapsesix" class="panel-collapse collapse">
								<div class="panel-body">
									<p>That is totally your decision. If you would like to be there, we will happily work around your schedule. However, if you do not care to be there or cannot be there, we can provide your property with one of our secure lock boxes for a spare key. </p>
									<p>
										We do prefer you to be on location for our initial visit so you can sign paperwork, receive information, and have the opportunity to ask questions. We understand this is not always feasible, and our office will work with you to make sure that all these items are handled remotely, if necessary. </p>
									</div>
								</div>
							</div>
							<div class="panel panel-default repeatable">
								...
								<div id="collapseseven" class="panel-collapse collapse">
									<div class="panel-body">
										<p>Absolutely we can work with your tenants for everything from the initial emergency response up through service calls. However, since the tenant is not the property owner or the insured, they cannot make decisions on mitigation, and they cannot sign forms.</p>
									</div>
								</div>
							</div>
							<div class="panel panel-default repeatable">
							...
							<div class="panel panel-default repeatable">
								...
								<div id="collapsenine" class="panel-collapse collapse">
									<div class="panel-body">
										<p>Not usually. If items need to be moved out, we will let you know in advance and we will work with you and your insurance adjuster to determine the specifics of a pack out.
										</p>
									</div>
								</div>
							</div>
					...
					<div class="c6">
						<h1 class="editable" id="header-2">Water FAQ</h1>
						<div class="panel-group editable" id="accordion2">
							<div class="panel panel-default repeatable">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion2" href="#c2-1">
											Can I walk in the area being dried out?
										</a>
									</h4>
								</div>
								<div id="c2-1" class="panel-collapse collapse">
									<div class="panel-body">
										<p>
							...
							<div class="panel panel-default repeatable">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion2" href="#c2-2">
											Why are air movers and dehumidifiers used?
										</a>
									</h4>
								</div>
								<div id="c2-2" class="panel-collapse collapse">
									<div class="panel-body">
										<p>
							...
							<div class="panel panel-default repeatable">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion2" href="#c2-3">
											Can I use my dehumidifier and fans to dry water-damaged materials?
										</a>
									</h4>
								</div>
								<div id="c2-3" class="panel-collapse collapse">
									<div class="panel-body">
										<p>
							...
							<div class="panel panel-default repeatable">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion2" href="#c2-4">
											Will turning up the heat help dry things out?
										</a>
									</h4>
								</div>
								<div id="c2-4" class="panel-collapse collapse">
									<div class="panel-body">
										<p>
							...
							<div class="panel panel-default repeatable">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion2" href="#c2-5">
											Should I open the windows to help the drying process?
										</a>
									</h4>
								</div>
								<div id="c2-5" class="panel-collapse collapse">
									<div class="panel-body">
										<p>
							...
							<div class="panel panel-default repeatable">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion2" href="#c2-6">
											What is that smell?
										</a>
									</h4>
								</div>
								<div id="c2-6" class="panel-collapse collapse">
									<div class="panel-body">
										<p>
							...
							<div class="panel panel-default repeatable">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion2" href="#c2-7">
											My furniture is wet too, what do I do?
										</a>
									</h4>
								</div>
								<div id="c2-7" class="panel-collapse collapse">
									<div class="panel-body">
										<p>
											The extent of damage and the construction of the furniture will determine if your furniture can be restored. Your furniture must be dried before damage can be adequately assessed. Non-salvaeable furniture will be documented for you, and if any items need to be discarded, a customer release form will need to be signed. 
										</p>
									</div>
								</div>
							</div>
							<div class="panel panel-default repeatable">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion2" href="#c2-8">
											My wood floors are wet and buckling. Will they have to be replaced?
										</a>
									</h4>
								</div>
								<div id="c2-8" class="panel-collapse collapse">
									<div class="panel-body">
										<p>
							...
							<div class="panel panel-default repeatable">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion2" href="#c2-9">
											Why do you have to remove my carpet?
										</a>
									</h4>
								</div>
								<div id="c2-9" class="panel-collapse collapse">
									<div class="panel-body">
										<p>
											There are a few reasons why your carpet may not be salvageable:
											<ul>
												<li>Delamination – occurs when the backing separates from the carpet fiber</li>
												<li>Loss of adhesion – occurs when there is prolonged exposure to water or the age of the carpet</li>
												<li>Permanent stains</li>
												<li>Carpet covers wood flooring – in order to save the wood flooring the carpet will mostly likely have to be removed</li>
							...
							<div class="panel panel-default repeatable">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion2" href="#c2-10">
											What do you do with my rugs?
										</a>
									</h4>
								</div>
								<div id="c2-10" class="panel-collapse collapse">
									<div class="panel-body">
										<p>
							...
							<div class="panel panel-default repeatable">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion2" href="#c2-11">
											What about sewage contamination?
										</a>
									</h4>
								</div>
								<div id="c2-11" class="panel-collapse collapse">
									<div class="panel-body">
										<p>
							...
							<div class="panel panel-default repeatable">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion2" href="#c2-12">
											How do I know when my property is completely dry?
										</a>
									</h4>
								</div>
								<div id="c2-12" class="panel-collapse collapse">
									<div class="panel-body">
										<p>
					...
					<section>
						<div class="c6">
							...
							<div class="panel-group editable" id="accordion3">
								...
								<div class="panel panel-default repeatable">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#accordion3" href="#c3-2">
												Can I turn on my heating/air conditioning after a fire or smoke damage?
											</a>
										</h4>
									</div>
									<div id="c3-2" class="panel-collapse collapse">
										<div class="panel-body">
											<p>We recommend that you not turn on your furnace or air conditioning unit without clearance from an HVAC contractor. </p>
										</div>
									</div>
								</div>
								<div class="panel panel-default repeatable">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#accordion3" href="#c3-3">
												I need to have my contents packed out. Is there anything I should keep with me?
											</a>
										</h4>
									</div>
									<div id="c3-3" class="panel-collapse collapse">
										<div class="panel-body">
											<p>
												<ul>
													<li>Cash, check books, credit cards, etC</li>
													<li>Medications</li>
													<li>Personal documents like birth certificates, car titles, etc</li>
													<li>Pets</li>
													<li>Valuables such as collections, jewelry, paintings, etc</li>
						...
						<div class="c6">
							<h1 id="heading-4" class="editable">Billing FAQ</h1>
							<div class="panel-group" id="accordion4">
								<div class="panel panel-default repeatable">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#accordion4" href="#c4-1">
												Who is responsible for paying for your services?
											</a>
										</h4>
									</div>
									<div id="c4-1" class="panel-collapse collapse">
										<div class="panel-body">
											<p>
												Ultimately you, the property owner, are responsible for payment. As the property owner, you will need to sign our Authorization for Repairs & Payment form. If this is an insurance claim, SMNI generally collects only the deductible amount. You will receive an invoice for the deductible after we have received payment from your insurance provider for the balance. </p><p>
												If you have a particularly large loss your mortgage company may be included as a payee on the payment from your insurance company. If this happens feel free to contact our office and we will happily work with you and your mortgage company to obtain a signature. </p><p>
												If your claim is not covered or you decide not to file a claim you will hold full financial responsibility. SMNI requires a 25% deposit or $500 (whichever is greater) for any job that is considered a self-pay bases on an esimtate written by SMNI after an intial inpection. You will be invoiced for the remaining balance beyond your deposit at the completion of service.
											</p>
										</div>
									</div>
								</div>
								<div class="panel panel-default repeatable">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#accordion4" href="#c4-2">
												Will you bill my insurance company?
											</a>
										</h4>
									</div>
									<div id="c4-2" class="panel-collapse collapse">
										<div class="panel-body">
											<p>Yes, once you have filed a claim and received a claim number we can begin the process of working with your insurance carrier to make sure we follow their guideline and provide all the necessary paperwork so a bill can be submitted upon completion.</p>
										</div>
									</div>
								</div>
								<div class="panel panel-default repeatable">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#accordion4" href="#c4-3">
												I received an invoice and an estimate but I filed an insurance claim. Do I need to pay this?
											</a>
										</h4>
									</div>
									<div id="c4-3" class="panel-collapse collapse">
										<div class="panel-body">
											<p>Not unless you receive or received a check from your insurance provider for our services. Some providers pay their customers directly and some pay us directly. We send you a copy of your invoice and estimate so you have a copy of your records and so that if you receive a check you, will know what it is for. If you have any questions please do not hesitate to call our office, and we will happily assist you in determining what is owed, if anything. </p>
										</div>
									</div>
								</div>
								<div class="panel panel-default repeatable">
									<div class="panel-heading">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#accordion4" href="#c4-4">
												If I choose to pay out of pocket and not file an insurance claim do I have to pay up front?
											</a>
										</h4>
									</div>
									<div id="c4-4" class="panel-collapse collapse">
										<div class="panel-body">
											<p>We do not require payment in full to begin working. We will do an initial inspection; the scop determined will be given to our estimator so an estimate can be written up. Initial inspection begins at $125; if you decide to hire us after we have provided you with an estimate, this fee will be applied to your required deposit amount. </p><p>
											Your required deposit amount is based on your initial inspection estimate total. As general rule we require 25% of the total estimate or $500, whichever amount is greater. The remaining balance will be due on completion. </p><p>
							...
							<div class="panel panel-default repeatable">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordion4" href="#c4-5">
											Can I pay my balance owed by credit card?
										</a>
									</h4>
								</div>
								<div id="c4-5" class="panel-collapse collapse">
									<div class="panel-body">
										<p>Yes, we accept all major credit cards and can take those payments over the phone or you can come into our office in person.</p>
									</div>
								</div>
							</div>
